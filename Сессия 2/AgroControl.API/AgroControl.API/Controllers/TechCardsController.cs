...
namespace AgroControl.API.Controllers
{
    ...
    public class TechCardsController : ControllerBase
    {
        ...
        /// <summary>Получить список всех технологических карт</summary>
        [HttpGet]
        public async Task<IActionResult> GetAll() =>
            Ok(new { success = true, data = await _service.GetAllAsync() });

        /// <summary>Получить карточку технологической карты по ID</summary>
        [HttpGet("{id}")]
        ...
        /// <summary>Создать новую технологическую карту</summary>
        [HttpPost]
        ...
        /// <summary>Обновить технологическую карту (полное обновление)</summary>
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(int id, [FromBody] TechCard updated)
        {
            ...
            // при необходимости обновить шаги – добавить логику
            await _service.UpdateAsync(existing);
            return Ok(new { success = true, data = existing });
        }

        /// <summary>Изменить статус технологической карты (утвердить, архивировать и т.д.)</summary>
        [HttpPut("{id}/status")]
        ...
        /// <summary>Добавить шаг в технологическую карту</summary>
        [HttpPost("{id}/steps")]
        ...
        /// <summary>Удалить шаг из технологической карты</summary>
        ...
        /// <summary>Получить полную программу выполнения для партии</summary>
        [HttpGet("{id}/program")]
...
// Вам также потребуется добавить недостающие методы в TechCardService:
// UpdateAsync, AddStepAsync, DeleteStepAsync (реализация аналогична RecipeService)